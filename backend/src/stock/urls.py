...
urlpatterns = [
  ...
  path('upload/purchased-stock/csv', views.UploadCsvPurchasedStock.as_view(), name='upload_purchased_stock_csv'),
  path('download/purchased-stock/csv', views.DownloadCsvPurchasedStock.as_view(), name='download_purchased_stock_csv'),
  # Snapshot
